...
<div class="flex flex-col justify-around h-full">
	...
	<div>
		...
		<ul>
			<li>Favoritspel 🎮 BG3, Genshin Impact, TotK 🎮</li>
			<li>Favoritväxt 🌱 gullranka 🌱</li>
			<li>Favoritlyft 💪 marklyft, bänkpress 💪</li>
			<li>Favoritpyssel 🎨 DIY gamla möbler till något nytt 🎨</li>
		</ul>
	</div>
</div>
